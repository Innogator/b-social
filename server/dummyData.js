...
export default function () {
  ...
  Event.count().exec((err, count) => {
    ...
    const description1 = `Sed ut perspiciatis unde omnis iste natus error
      sit voluptatem accusantium doloremque laudantium, totam rem aperiam,
      eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae
      vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit
      aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos
    ...
    const event1 = new Event({ title: 'Coding at the beach', slug: 'coding-at-the-beach', cuid: 'cikqgkv4q01ck7453ualdn3hy', description: description1, date: new Date() });
    const event2 = new Event({ title: 'A Concert', slug: 'a-concert', cuid: 'cikqgkv4q01ck7453ualdn3hz', description: description2, date: new Date() });
